        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="md:hidden overflow-hidden border-t border-primary-200/30"
            >
              <div className="py-6 space-y-2 px-4">
                {[
                  ...
                  >
                    <Link
                      href={item.href}
                      className="block text-gray-700 hover:text-accent-600 transition px-4 py-3 rounded-xl hover:bg-accent-50 font-light"
                ...
                >
                  <Link
                    href="/contact"
                    className="block bg-gradient-to-r from-accent-500 to-accent-600 text-white text-center px-4 py-3 rounded-xl font-normal shadow-lg"
                    onClick={() => setIsOpen(false)}
                  >
                    Get Started
                  </Link>
